const CACHE_NAME = 'tech-check-owner-quick-find-20260923au';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-quick-find-20260923au', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-quick-find-20260923au', { cache:'reload' })),
