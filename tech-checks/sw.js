const CACHE_NAME = 'tech-check-helios-field-sequence-20260924o';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=helios-field-sequence-20260924o', { cache:'reload' })),
      cache.add(new Request('./app.js?v=helios-field-sequence-20260924o', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=helios-field-sequence-20260924o', { cache:'reload' })),
