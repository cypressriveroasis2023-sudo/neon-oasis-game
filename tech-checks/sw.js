const CACHE_NAME = 'tech-check-field-shell-v79';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=rules-v5', { cache:'reload' })),
      cache.add(new Request('./app.js?v=startup-fast-v37', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=release-qa-v123', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision-company-knowledge.js?v=company-knowledge-v6', { cache:'reload' })),
