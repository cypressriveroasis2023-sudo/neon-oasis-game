const CACHE_NAME = 'tech-check-gps-weather-scroll-20260922j';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=gps-weather-scroll-20260922j', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=gps-weather-scroll-20260922j', { cache:'reload' })),
