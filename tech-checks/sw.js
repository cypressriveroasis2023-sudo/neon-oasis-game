const CACHE_NAME = 'tech-check-owner-unified-20260921c';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-unified-20260921c', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-unified-20260921c', { cache:'reload' })),
