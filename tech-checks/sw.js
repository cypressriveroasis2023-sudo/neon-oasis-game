const CACHE_NAME = 'tech-check-it-readonly-queue-20260922a';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=it-readonly-queue-20260922a', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=it-readonly-queue-20260922a', { cache:'reload' })),
