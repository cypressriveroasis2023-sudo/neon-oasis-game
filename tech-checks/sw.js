const CACHE_NAME = 'tech-check-command-center-standard-20260923y';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=command-center-standard-20260923y', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=it-ops-lead-20260923a', { cache:'reload' })),
