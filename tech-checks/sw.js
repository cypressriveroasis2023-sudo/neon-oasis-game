const CACHE_NAME = 'tech-check-helios-yard-20260924c';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=helios-yard-20260924c', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=helios-yard-20260924c', { cache:'reload' })),
