const CACHE_NAME = 'tech-check-owner-control-next-20260923as';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-control-next-20260923as', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-control-next-20260923as', { cache:'reload' })),
