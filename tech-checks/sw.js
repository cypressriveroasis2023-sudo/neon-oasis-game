const CACHE_NAME = 'tech-check-helios-connect-20260924d';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=helios-connect-20260924d', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=helios-connect-20260924d', { cache:'reload' })),
