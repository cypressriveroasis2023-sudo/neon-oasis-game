const CACHE_NAME = 'tech-check-owner-test-persona-20260923bc';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-test-persona-20260923bc', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-test-persona-20260923bc', { cache:'reload' })),
