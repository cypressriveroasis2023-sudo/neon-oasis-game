const CACHE_NAME = 'tech-check-field-shell-v137';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-command-v62', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=owner-command-v145', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision-live-data.js?v=live-data-v4', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.js?v=vision-workspace-v43', { cache:'reload' }))
    ]);
