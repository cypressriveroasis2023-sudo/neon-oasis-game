const CACHE_NAME = 'tech-check-field-shell-v108';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-command-v45', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=owner-command-v135', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision-company-knowledge.js?v=company-knowledge-v13', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.js?v=vision-workspace-v32', { cache:'reload' }))
    ]);
