const CACHE_NAME = 'tech-check-owner-unified-20260921b';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-unified-20260921a', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-unified-20260921b', { cache:'reload' })),
