const CACHE_NAME = 'tech-check-service-one-check-20260924k';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=service-one-check-20260924k', { cache:'reload' })),
      cache.add(new Request('./app.js?v=service-one-check-20260924k', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=service-one-check-20260924k', { cache:'reload' })),
