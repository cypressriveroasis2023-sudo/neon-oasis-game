const CACHE_NAME = 'tech-check-field-shell-v203';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-structural-v203', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-structural-v203', { cache:'reload' })),
