const CACHE_NAME = 'tech-check-mobile-vision-viewport-20260922k';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=mobile-vision-viewport-20260922k', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=mobile-vision-viewport-20260922k', { cache:'reload' })),
