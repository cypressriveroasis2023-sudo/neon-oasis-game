const CACHE_NAME = 'tech-check-helios-login-hotfix-20260926ag';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=helios-login-hotfix-20260926ag', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=helios-login-hotfix-20260926ag', { cache:'reload' })),
