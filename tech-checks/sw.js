const CACHE_NAME = 'tech-check-owner-test-persona-20260923bg';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-test-persona-20260923bg', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=owner-test-persona-20260923bg', { cache:'reload' })),
