const CACHE_NAME = 'tech-check-it-inline-ticket-20260922c';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=it-inline-ticket-20260922c', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=it-inline-ticket-20260922c', { cache:'reload' })),
