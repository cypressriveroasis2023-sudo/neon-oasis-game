const CACHE_NAME = 'tech-check-field-shell-v75';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=rules-v1', { cache:'reload' })),
      cache.add(new Request('./app.js?v=startup-fast-v33', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=release-qa-v119', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.css?v=vision-workspace-v15', { cache:'reload' })),
      cache.add(new Request('./onsite-vision-company-knowledge.js?v=company-knowledge-v2', { cache:'reload' })),
      cache.add(new Request('./onsite-vision-workflow-engine.js?v=workflow-engine-v3', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.js?v=vision-workspace-v15', { cache:'reload' }))
    ]);
