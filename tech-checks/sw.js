const CACHE_NAME = 'tech-check-stable-guided-tour-20260922g';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=stable-guided-tour-20260922g', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=stable-guided-tour-20260922g', { cache:'reload' })),
