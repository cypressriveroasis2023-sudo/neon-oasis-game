const CACHE_NAME = 'tech-check-it-locked-tutorial-20260922b';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=it-locked-tutorial-20260922b', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=it-locked-tutorial-20260922b', { cache:'reload' })),
