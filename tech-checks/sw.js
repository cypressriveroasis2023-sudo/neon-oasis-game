const CACHE_NAME = 'tech-check-owner-controls-v3-20260923at';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-controls-v3-20260923at', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-controls-v3-20260923at', { cache:'reload' })),
