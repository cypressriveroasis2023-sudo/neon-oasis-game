const CACHE_NAME = 'tech-check-mobile-desktop-auth-20260923ap';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=mobile-desktop-auth-20260923ap', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-bottom-nav-20260923ao', { cache:'reload' })),
