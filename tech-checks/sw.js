const CACHE_NAME = 'tech-check-helios-alibi-check-20260924l';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=helios-alibi-check-20260924l', { cache:'reload' })),
      cache.add(new Request('./app.js?v=helios-alibi-check-20260924l', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=helios-alibi-check-20260924l', { cache:'reload' })),
