const CACHE_NAME = 'tech-check-field-shell-v174';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-command-v80', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-command-v123', { cache:'reload' })),
