const CACHE_NAME = 'tech-check-calendar-command-center-20260922g';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=calendar-command-center-20260922g', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=calendar-command-center-20260922g', { cache:'reload' })),
