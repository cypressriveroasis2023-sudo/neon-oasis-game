const CACHE_NAME = 'tech-check-real-account-test-switch-20260923ay';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=real-account-test-switch-20260923ay', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=real-account-test-switch-20260923ay', { cache:'reload' })),
