const CACHE_NAME = 'tech-check-field-shell-v82';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./onsite-vision.css?v=vision-workspace-v18', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.js?v=vision-workspace-v18', { cache:'reload' }))
    ]);
