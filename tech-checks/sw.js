const CACHE_NAME = 'tech-check-field-shell-v78';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=rules-v4', { cache:'reload' })),
      cache.add(new Request('./app.js?v=startup-fast-v36', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=release-qa-v122', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.css?v=vision-workspace-v16', { cache:'reload' })),
      cache.add(new Request('./onsite-vision-company-knowledge.js?v=company-knowledge-v5', { cache:'reload' })),
      cache.add(new Request('./onsite-vision-workflow-engine.js?v=workflow-engine-v4', { cache:'reload' })),
      ...
      cache.add(new Request('./onsite-vision.js?v=vision-workspace-v16', { cache:'reload' }))
    ]);
