const CACHE_NAME = 'tech-check-owner-command-20260923ar';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-command-20260923ar', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-command-20260923ar', { cache:'reload' })),
