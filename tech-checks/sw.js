const CACHE_NAME = 'tech-check-owner-today-weather-20260922i';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=owner-today-weather-20260922i', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=owner-today-weather-20260922i', { cache:'reload' })),
