const CACHE_NAME = 'tech-check-test-account-chooser-20260923az';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./app.js?v=test-account-chooser-20260923az', { cache:'reload' })),
      ...
      cache.add(new Request('./styles.css?v=test-account-chooser-20260923az', { cache:'reload' })),
