const CACHE_NAME = 'tech-check-mppt-multi-photo-20260924j';
const APP_SHELL = './';
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request('./tech-check-rules.js?v=mppt-multi-photo-20260924j', { cache:'reload' })),
      cache.add(new Request('./app.js?v=mppt-multi-photo-20260924j', { cache:'reload' })),
      cache.add(new Request('./technician-wizard-owner-dashboard-v5.js?v=mppt-multi-photo-20260924j', { cache:'reload' })),
