  ...
  const guides={
    ...
    'service:TRUCK SPARES':{
      steps:[
        ...
        'For a backup unit you did NOT use, tap RETURN UNUSED → IT INTAKE. It goes directly back to Shop Inventory and does not need IT Intake.',
